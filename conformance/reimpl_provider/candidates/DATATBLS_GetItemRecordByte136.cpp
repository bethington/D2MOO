...
// D2MOO_REIMPL_EXPORT: DATATBLS_GetItemRecordByte136
// pUnit(item) -> GetItemDataRecord + byte@0x136
typedef void* (__stdcall* _rec_t)(unsigned int);
extern "C" unsigned int __stdcall DATATBLS_GetItemRecordByte136(void* pUnit)
{
    ...
    return (unsigned int)*(unsigned char*)(rec + 0x136);
}
