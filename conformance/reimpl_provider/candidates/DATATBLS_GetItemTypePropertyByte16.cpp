...
// D2MOO_REIMPL_EXPORT: DATATBLS_GetItemTypePropertyByte16
// pUnit -> ItemTypes[idx]+0x16, default 1
typedef int (__stdcall* _gt_t)(void*);
extern "C" unsigned int __stdcall DATATBLS_GetItemTypePropertyByte16(void* pUnit)
{
            ...
            if (idx >= 0) {
                ...
                if (_g != nullptr) {
                    ...
                    if (dt != nullptr && idx < *(int*)(dt + 0xbfc)) {
                        ...
                        return (unsigned int)*(unsigned char*)(rec + 0x16);
                    }
                }
            }
        }
