...
// D2MOO_REIMPL_EXPORT: DATATBLS_GetItemRecordByte129
// pUnit(item) -> GetItemDataRecord + byte@0x129 (bBaseTierFlag)
typedef void* (__stdcall* _rec_t)(unsigned int);
extern "C" unsigned int __stdcall DATATBLS_GetItemRecordByte129(void* pUnit)
{
    ...
    return (unsigned int)*(unsigned char*)(rec + 0x129);
}
