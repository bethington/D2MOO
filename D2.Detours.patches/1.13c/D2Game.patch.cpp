...
extern "C" {
    ...
    __declspec(dllexport)
    constexpr int __cdecl GetLastOrdinal() { return 10'060; }
...
static PatchAction patchActions[GetOrdinalCount()] = {
    ...
    PatchAction::FunctionReplacePatchByOriginal,     //   D2Game_10000                                                     @10000
    ...
    PatchAction::Ignore,                             //   ; Not exported                                                   @10030
    PatchAction::Ignore,                             //   ; Not exported                                                   @10031
    PatchAction::Ignore,                             //   ; Not exported                                                   @10032
