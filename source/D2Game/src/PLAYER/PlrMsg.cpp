...
typedef int32_t(__fastcall* SERVERPACKETCALLBACK)(Game* pGame, UnitAny* pUnit, void* pPacket, int nPacketSize);

struct ServerPacketTable
{
...
#pragma pack(push, 1)
using PlrMsgFunc = void(__fastcall*)(Game*, UnitAny*, GameClient*, int32_t);
struct UnkPlrMsg
{
    PlrMsgFunc field_0;
    int32_t field_4;
...
constexpr UnkPlrMsg stru_6FD30708[20] =
{
...
int32_t __fastcall sub_6FC82360(UnitAny* pUnit, UnitAny* pUnit2, int32_t bSkipHpCheck)
{
    ...
    GameClient* pClient = SUNIT_GetClientFromPlayer(pUnit2, __FILE__, __LINE__);
    if (!pClient)
    {
        return 0;
    }
    
    ClientPlayerData* pClientPlayerData = CLIENTS_GetClientPlayerData(pClient);    
...
void __fastcall sub_6FC82830(UnitAny* pUnit, GameClient* pClient)
{
    ...
    if (pPlayer != pUnit)
    {
        ...
        {
            GameClient* pPlayerClient = SUNIT_GetClientFromPlayer(pPlayer, __FILE__, __LINE__);
...
int32_t __fastcall sub_6FC828D0(UnitAny* pPlayer, int32_t nUnitType, int32_t nUnitGUID, int32_t a4, Game* pGame)
{
    ...
    case UNIT_PLAYER:
    {
        UnitAny* pUnit = SUNIT_GetServerUnit(pGame, 0, nUnitGUID);
        if (!pUnit)
        {
            return 1;
        }
    ...
    case UNIT_MONSTER:
    {
        UnitAny* pUnit = SUNIT_GetServerUnit(pGame, UNIT_MONSTER, nUnitGUID);
        if (!pUnit)
        {
            return 1;
        }
    ...
    case UNIT_OBJECT:
    {
        UnitAny* pUnit = SUNIT_GetServerUnit(pGame, UNIT_OBJECT, nUnitGUID);
        if (!pUnit)
        {
            return 1;
        }
    ...
    case UNIT_ITEM:
    {
        UnitAny* pUnit = SUNIT_GetServerUnit(pGame, UNIT_ITEM, nUnitGUID);
    ...
    case UNIT_TILE:
    {
        UnitAny* pUnit = SUNIT_GetServerUnit(pGame, UNIT_TILE, nUnitGUID);
        if (!pUnit)
        {
            return 1;
        }
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x02_WalkToEntity_6FC82ED0(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    ...
    UnitAny* pItem = SUNIT_GetServerUnit(pGame, nUnitType, nItemGUID);
    if (!pItem)
    {
        return 1;
    }
...
int32_t __fastcall sub_6FC83340(Game* pGame, UnitAny* pUnit, Skill* pSkill, int32_t nX, int32_t nY)
{
    ...
    SkillsTxt* pSkillsTxtRecord = SKILLS_GetSkillsTxtRecordFromSkill(pUsedSkill);
    if (!pSkillsTxtRecord)
    {
        return 2;
    }
...
Skill* __fastcall sub_6FC83450(UnitAny* pUnit, Skill* pSkill)
{
    ...
    Skill* pSwapSkill = SKILLS_GetSkillById(pUnit, SKILL_LEFTHANDSWING, -1);
...
int32_t __fastcall sub_6FC836D0(Game* pGame, UnitAny* pUnit, Skill* pSkill, int32_t nUnitType, int32_t nUnitGUID, int32_t a6)
{
    ...
    UnitAny* pOtherUnit = SUNIT_GetServerUnit(pGame, nUnitType, nUnitGUID);
    if (pOtherUnit && STATES_CheckState(pOtherUnit, STATE_ATTACHED))
    {
        UnitAny* pOwner = SUNIT_GetOwner(pGame, pOtherUnit);
        if (pOwner)
        {
...
{
    GSPacketClt09* pPacket09 = (GSPacketClt09*)pPacket;

    if (nSize != sizeof(GSPacketClt09))
    {
        return 3;
    }
    ...
    UnitAny* pItem = SUNIT_GetServerUnit(pGame, pPacket09->dwUnitType, pPacket09->dwUnitGUID);
    if (!pItem)
    {
        return 1;
    }
...
{
    GSPacketClt0A* pPacket0A = (GSPacketClt0A*)pPacket;

    if (nSize != sizeof(GSPacketClt0A))
    {
        return 3;
    }
    ...
    UnitAny* pItem = SUNIT_GetServerUnit(pGame, pPacket0A->dwUnitType, pPacket0A->dwUnitGUID);
    if (!pItem)
    {
        return 1;
    }
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x10_RightSkillOnUnitHold_6FC84330(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    ...
    UnitAny* pItem = SUNIT_GetServerUnit(pGame, nUnitType, nUnitGUID);
    if (!pItem)
    {
        return 1;
    }
    ...
    Skill* pSkill = UNITS_GetRightSkill(pUnit);
    if (pSkill)
    {
...
{
    GSPacketClt11* pPacket11 = (GSPacketClt11*)pPacket;

    if (nSize != sizeof(GSPacketClt11))
    {
        return 3;
    }
    ...
    UnitAny* pItem = SUNIT_GetServerUnit(pGame, pPacket11->dwUnitType, pPacket11->dwUnitGUID);
    if (!pItem)
    {
        return 1;
    }
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x14_HandleOverheadChat_6FC84690(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    ...
    if (nStringLength < 256)
    {
        ...
        HoverText* pHoverText = CHAT_AllocHoverMsg(pGame->pMemoryPool, szText, pGame->dwGameFrame);
        if (pHoverText)
        {
...
{
    GSPacketSrv26Args* pPacket26Args = (GSPacketSrv26Args*)pArgs;
    Game* pGame = CLIENTS_GetGame(pClient);

    if (pPacket26Args->nUnitId != -1)
    {
        UnitAny* pOtherPlayer = SUNIT_GetServerUnit(pGame, UNIT_PLAYER, pPacket26Args->nUnitId);
        ...
        if (pOtherPlayer && pLocalPlayer && pOtherPlayer != pLocalPlayer)
        {
            ...
            {
                UnitAny* pInteractUnit = SUNIT_GetServerUnit(pGame, UNIT_PLAYER, nUnitGUID);
...
void __fastcall D2GAME_PACKETS_HandleWhisper_6FC848A0(GameClient* pClient, void* pArgs)
{
    ...
    if (!SStrCmpI(CLIENTS_GetName(pClient), pPacket26Args->pPacket15->szName, INT_MAX))
    {
        ...
        if (nUnitGUID != -1)
        {
            UnitAny* pReceiver = SUNIT_GetServerUnit(pGame, UNIT_PLAYER, nUnitGUID);
            UnitAny* pLocalPlayer = CLIENTS_GetPlayerFromClient(pClient, 0);
...
{
    D2GAME_PACKETS_SendPacket0x26_ServerMessage_6FC3DDF0(pClient, (GSPacketSrv26*)pMsg);
}
...
{
    GSPacketClt15* pPacket15 = (GSPacketClt15*)pPacket;

    GSPacketClt15 packet15 = {};
    ...
    void(__fastcall * pFn)(GameClient*, void*) = nullptr;
    if (bWhisper)
    {
    ...
    GSPacketSrv26Args packet26Args = {};
...
{
    D2GAME_PACKETS_SendPacket0x5A_6FC3DEC0(pClient, (GSPacketSrv5A*)pPacket);
}
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x1C_RemoveBodyItem_6FC854B0(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 3)
    {
        ...
        if (nBodyLoc > 0 && nBodyLoc < 11)
        {
            UnitAny* pItem = INVENTORY_GetItemFromBodyLoc(pUnit->pInventory, nBodyLoc);
        ...
        if (pItem && pItem->dwAnimMode == 4 && INVENTORY_GetCursorItem(pUnit->pInventory) == pItem)
        {
            if (nBodyLoc > 0 && nBodyLoc < 11)
            {
                if (INVENTORY_GetItemFromBodyLoc(pUnit->pInventory, nBodyLoc))
                {
                    ...
                    UnitAny* pEquippedItem = INVENTORY_GetItemFromBodyLoc(pUnit->pInventory, nBodyLoc);
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x1F_SwapCursorBufferItems_6FC857C0(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 17)
    {
        ...
        {
            UnitAny* pInventoryItem = SUNIT_GetServerUnit(pGame, UNIT_ITEM, nInventoryItemGUID);
...
{
    GSPacketClt20* pPacket20 = (GSPacketClt20*)pPacket;
...
{
    GSPacketClt27* pPacket27 = (GSPacketClt27*)pPacket;

    if (nSize == 9)
    {        
        D2_ASSERT(pGame);

        UnitAny* pTargetItem = SUNIT_GetServerUnit(pGame, UNIT_ITEM, pPacket27->nTargetItemGUID);
        ...
        {
            UnitAny* pUseItem = SUNIT_GetServerUnit(pGame, UNIT_ITEM, pPacket27->nUseItemGUID);
...
{
    GSPacketClt26* pPacket26 = (GSPacketClt26*)pPacket;

    if (nSize != sizeof(GSPacketClt26))
    {
        return 3;
    }
    ...
    UnitAny* pItem = SUNIT_GetServerUnit(pGame, UNIT_ITEM, pPacket26->nItemGUID);
    if (!pItem || pItem->dwAnimMode != IMODE_INBELT || !INVENTORY_CompareWithItemsParentInventory(pUnit->pInventory, pItem))
    {
        return 1;
    }
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x28_SocketItem_6FC86310(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 9)
    {
        ...
        if (pCursorItem && pCursorItem->dwAnimMode == IMODE_ONCURSOR && INVENTORY_GetCursorItem(pUnit->pInventory) == pCursorItem)
        {
            UnitAny* pSocketableItem = SUNIT_GetServerUnit(pGame, UNIT_ITEM, nSocketableItemGUID);
            if (pSocketableItem && (pSocketableItem->dwAnimMode == IMODE_STORED || pSocketableItem->dwAnimMode == IMODE_EQUIP) && INVENTORY_CompareWithItemsParentInventory(pUnit->pInventory, pSocketableItem))
            {
                ...
                {
                    UnitAny* pInteractUnit = SUNIT_GetServerUnit(pGame, nUnitType, nUnitGUID);
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x2F_InitEntityChat_6FC868C0(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 9)
    {
        UnitAny* pMonster = SUNIT_GetServerUnit(pGame, UNIT_MONSTER, *(int32_t*)((char*)pPacket + 5));
        if (pMonster)
        {
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x32_BuyItemFromNpcBuffer_6FC86AE0(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 17)
    {
        GSPacketClt32* pPacket32 = (GSPacketClt32*)pPacket;
...
{
    GSPacketClt38* pPacket38 = (GSPacketClt38*)pPacket;
    if (nSize == 13)
    {
...
{
    GSPacketClt3A* pPacket3A = (GSPacketClt3A*)pPacket;
...
{
    GSPacketClt3B* pPacket3B = (GSPacketClt3B*)pPacket;
    if (nSize == 3)
    {
...
{
    GSPacketClt44* pPacket44 = (GSPacketClt44*)pPacket;
    if (nSize != 17)
    {
        return 3;
    }
    ...
    UnitAny* pObject = SUNIT_GetServerUnit(pGame, UNIT_OBJECT, pPacket44->nAnvilInteractGUID);
    if (!pObject)
    {
        return 1;
    }
    ...
    if (pPacket44->nState != 2)
    {
        ...
        UnitAny* pItem = SUNIT_GetServerUnit(pGame, UNIT_ITEM, pPacket44->nItemGUID);
        if (!pItem || pItem->dwAnimMode != IMODE_ONCURSOR || INVENTORY_GetCursorItem(pUnit->pInventory) != pItem)
        {
            return 1;
        }
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x45_ChangeTpLocation_6FC87930(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    ...
    GSPacketClt45* pPacket45 = (GSPacketClt45*)pPacket;
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x46_MercInteract_6FC87B00(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    ...
    UnitAny* pMerc = SUNIT_GetServerUnit(pGame, UNIT_MONSTER, nMercGUID);
...
{
    GSPacketClt49* pPacket49 = (GSPacketClt49*)pPacket;
    if (nPacketSize != 9)
    {
        return 3;
    }

    UnitAny* pWaypoint = SUNIT_GetServerUnit(pGame, UNIT_OBJECT, pPacket49->nWaypointGUID);
    int32_t nResult = 0;
    if (pWaypoint)
    {
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x4B_RequestEntityUpdate_6FC880F0(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 9)
    {
        ...
        if (nUnitType < 6)
        {
            UnitAny* pUnit = SUNIT_GetServerUnit(pGame, nUnitType, *(int32_t*)((char*)pPacket + 5));
...
{
    GSPacketClt51* pPacket51 = (GSPacketClt51*)pPacket;
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x59_MakeEntityMove_6FC88400(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    if (nSize == 17)
    {
        ...
        if (nUnitType < 6)
        {
            UnitAny* pNpc = SUNIT_GetServerUnit(pGame, nUnitType, nUnitGUID);
...
{
    GSPacketClt5F* pPacket5F = (GSPacketClt5F*)pPacket;

    if (nSize != sizeof(GSPacketClt5F))
    {
        return 3;
    }
    ...
    UnitAny* pTargetUnit = SUNIT_GetTargetUnit(pGame, pUnit);
    ...
    StatList* pStatList = STATLIST_AllocStatList(pGame->pMemoryPool, 2u, pGame->dwGameFrame + nDelay, pUnit->dwUnitType, pUnit->dwUnitId);
...
int32_t __fastcall D2GAME_PACKETCALLBACK_Rcv0x61_DropPickupMercItem_6FC88930(Game* pGame, UnitAny* pUnit, void* pPacket, int32_t nSize)
{
    ...
    UnitAny* pMerc = sub_6FC7E8B0(pGame, pUnit, 7, 0);
    ...
    UnitAny* pItem = INVENTORY_GetCursorItem(pUnit->pInventory);
    if (pItem)
    {
    ...
    UnitAny* pEquippedItem = INVENTORY_GetItemFromBodyLoc(pMerc->pInventory, nBodyLoc);
    if (pEquippedItem && pEquippedItem->dwAnimMode == IMODE_EQUIP && pEquippedItem == INVENTORY_RemoveItemFromInventory(pMerc->pInventory, pEquippedItem))
    {
        ...
        UnitAny* pCursorItem = ITEMS_Duplicate(pGame, pEquippedItem, pUnit, 1);
...
int32_t __fastcall D2GAME_MERCS_EquipItem_6FC88D10(Game* pGame, UnitAny* pPlayer, UnitAny* pMerc, UnitAny* pItem)
{
    ...
    Inventory* pMercInventory = pMerc->pInventory;
    if (!pMercInventory)
    {
        return 0;
    }
    ...
    UnitAny* pExchangeItem = INVENTORY_GetItemFromBodyLoc(pMercInventory, nBodyLoc1);
    UnitAny* pTempItem = INVENTORY_GetItemFromBodyLoc(pMercInventory, nBodyLoc2);
    ...
    UnitAny* pDupeItem = ITEMS_Duplicate(pGame, pItem, pMerc, 1);
    ...
    if (pExchangeItem)
    {
        UnitAny* pCursorItem = ITEMS_Duplicate(pGame, pExchangeItem, pPlayer, 1);
...
{
    ServerPacketTable gpPacketCallbackTable_6FD28FA0[] =
    {
        { nullptr, 0 },
