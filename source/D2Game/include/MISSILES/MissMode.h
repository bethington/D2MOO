...
struct MissileUnitFindArg
{
    Game* pGame;
    UnitAny* pMissile;
    UnitAny* pOwner;
    MissilesTxt* pMissilesTxtRecord;
};

using MissileUnitFindFunc = int32_t(__fastcall*)(UnitAny*, void*);
struct MissileUnitFindTable
{
...
extern MissileUnitFindTable stru_6FD2E5F8[9];
...
//D2Game.0x6FC60080
void __fastcall MISSMODE_ToggleStateOff(UnitAny* pUnit, int32_t nState, struct StatList* pStatList);
//D2Game.0x6FC60090
