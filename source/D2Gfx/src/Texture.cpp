...
void __stdcall TEXTURE_CelFlatSpriteDraw(GfxData* pData, int32_t nXPos, int32_t nYPos, uint32_t dwGamma, DrawMode eDrawMode, int32_t nScreenMode, uint8_t* pPalette)
{
...
void __stdcall TEXTURE_CelDraw(GfxData* pData, int32_t nXPos, int32_t nYPos, uint32_t dwGamma, DrawMode eDrawMode, uint8_t* pPalette)
{
    return gpGraphicsInterface->pfCelDraw(pData, nXPos, nYPos, dwGamma, eDrawMode, pPalette);
}

//D2Gfx.0x6FA742D0 (#10073)
void __stdcall TEXTURE_CelDrawColor(GfxData* pData, int32_t nXPos, int32_t nYPos, uint32_t dwGamma, DrawMode eDrawMode, int32_t nGlobalPaletteShift)
{
    return gpGraphicsInterface->pfCelDrawColor(pData, nXPos, nYPos, dwGamma, eDrawMode, nGlobalPaletteShift);
}

//D2Gfx.0x6FA74300 (#10074)
void __stdcall TEXTURE_CelDrawEx(GfxData* pData, int32_t nXPos, int32_t nYPos, int32_t nSkipLines, int32_t nDrawLines, DrawMode eDrawMode)
{
    if (nDrawLines)
    {
...
void __stdcall TEXTURE_CelDrawClipped(GfxData* pData, int32_t nXPos, int32_t nYPos, void* pCropRect, DrawMode eDrawMode)
{
    return gpGraphicsInterface->pfCelDrawClipped(pData, nXPos, nYPos, pCropRect, eDrawMode);
}

//D2Gfx.0x6FA74360 (#10075)
void __stdcall TEXTURE_CelDrawShadow(GfxData* pData, int32_t nXPos, int32_t nYPos)
{
    return gpGraphicsInterface->pfCelDrawShadow(pData, nXPos + 2, nYPos);
}

//D2Gfx.0x6FA74380 (#10076)
void __stdcall TEXTURE_CelDrawHilight(GfxData* pData, int32_t nXPos, int32_t nYPos, uint8_t nPaletteIndex)
{
