...
D2WIN_DLL_DECL CellFile* __fastcall ARCHIVE_LoadCellFile(const char* szFile, int32_t nType);
//D2Win.0x6F8A5A50 (#10040)
D2WIN_DLL_DECL CellFile* __fastcall ARCHIVE_LoadCellFileWithFileSize(const char* szFile, uint32_t* pFileSize, int32_t nType);
//D2Win.0x6F8A5AE0 (#10041)
D2WIN_DLL_DECL void __fastcall ARCHIVE_FreeCellFile(CellFile* pCellFile);
...
D2WIN_DLL_DECL BOOL __fastcall ARCHIVE_LoadExpansionArchives(ARCHIVE_ShowMessageFunctionPtr pfShowInsertPlayDisc, ARCHIVE_ShowMessageFunctionPtr pfShowInsertExpansionDisc, HANDLE hFile, Config* pConfig);
