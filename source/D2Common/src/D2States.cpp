...
void __stdcall STATES_ToggleState(UnitAny* pUnit, int nState, BOOL bSet)
{
	if (nState >= 0 && nState < sgptDataTables->nStatesTxtRecordCount)
	{
...
BOOL __stdcall STATES_CheckState(UnitAny* pUnit, int nState)
{
...
void __stdcall STATES_ToggleGfxStateFlag(UnitAny* pUnit, int nState, BOOL bSet)
{
...
BOOL __stdcall STATES_CheckGfxStateFlag(UnitAny* pUnit, int nState)
{
...
void __stdcall STATES_ClearGfxStateFlags(UnitAny* pUnit)
{
	uint32_t* pGfxFlags = D2COMMON_STATES_GetListGfxFlags_6FDB8AC0(pUnit);
...
BOOL __stdcall STATES_IsAnyGfxStateFlagSet(UnitAny* pUnit)
{
	uint32_t* pGfxFlags = NULL;
	int nCounter = 0;
...
uint32_t* __stdcall STATES_GetGfxStateFlags(UnitAny* pUnit)
{
	D2_ASSERT(pUnit);
...
void __stdcall STATES_UpdateStayDeathFlags(UnitAny* pUnit, BOOL bIsBoss)
{
...
uint32_t* __stdcall D2COMMON_10494_STATES_GetStatFlags(UnitAny* pUnit)
{
...
BOOL __stdcall STATES_CheckStateMaskAuraOnUnit(UnitAny* pUnit)
{
...
BOOL __stdcall STATES_CheckStateMaskPgsvOnUnit(UnitAny* pUnit)
{
	return STATES_CheckStateMaskOnUnit(pUnit, STATEMASK_PGSV);
}

//D2Common.0x6FDB4A80 (#10501)
void __stdcall STATES_UpdatePgsvFlags(UnitAny* pUnit)
{
	uint32_t* pStatFlags = NULL;
	uint32_t* pGfxFlags = NULL;
...
BOOL __stdcall STATES_CheckStateMaskStayDeathOnUnitByStateId(UnitAny* pUnit, int nState)
{
	if (nState >= 0 && nState < sgptDataTables->nStatesTxtRecordCount)
	{
...
BOOL __stdcall STATES_CheckStateMaskShatterOnUnit(UnitAny* pUnit)
{
...
BOOL __stdcall STATES_CheckStateMaskLifeOnUnit(UnitAny* pUnit)
{
	return STATES_CheckStateMaskOnUnit(pUnit, STATEMASK_LIFE);
}

//D2Common.0x6FDB5660 (#10560)
BOOL __stdcall STATES_CheckStateMaskUdeadOnUnit(UnitAny* pUnit)
{
	return STATES_CheckStateMaskOnUnit(pUnit, STATEMASK_UDEAD);
}

//D2Common.0x6FDB56D0 (#10561)
BOOL __stdcall STATES_CheckStateMaskGreenOnUnit(UnitAny* pUnit)
{
	return STATES_CheckStateMaskOnUnit(pUnit, STATEMASK_GREEN);
}

//D2Common.0x6FDB5740 (#11303)
BOOL __stdcall STATES_CheckStateMaskOnUnit(UnitAny* pUnit, int nStateMask)
{
