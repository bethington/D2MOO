...
struct DrlgOutDesertInit				// size: 0x10
{
...
{
	DrlgOrth* pTownRoomData = pLevel->pOutdoors->pRoomData;
...
{
	static const DrlgOutDesertInit pOutDesertInit[8][5] =
	{
		{
...
{
	static const DrlgOutDesertInit pOutDesertInit[9] =
	{
