...
D2COMMON_DLL_DECL ArenaTxt* __fastcall DATATBLS_GetArenaTxtRecord(int nArenaType);
//D2Common.0x6FD479B0
...
D2COMMON_DLL_DECL CharTemplateTxt* __fastcall DATATBLS_GetCharTemplateTxtRecord(int nTemplate, int nLevel);
